...
function create_fs {
    ...
    local repo_url="${GIT_SERVER_URL}/${repo_id}" # Change this to the URL of your Git repository
    ...
    git clone "${repo_url}" "${rootfs}/repo" || { echo "Failed to clone repository"; ./cleanup --vm-id $repo_id; return 1; }
