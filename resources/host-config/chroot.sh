...
packages="udev systemd-sysv openssh-server iproute2 curl socat python3-minimal iperf3 iputils-ping fio kmod tmux hwloc-nox vim-tiny trace-cmd linuxptp git ca-certificates gcc libc6-dev"
...
# Set a hostname.
echo "dotcodeschool" > /etc/hostname
